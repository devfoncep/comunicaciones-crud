...
@Entity
@Cacheable(false)
@NamedQueries({ @NamedQuery(name = "Folderfolders.findAll", 
                            query = "select o from Folderfolders o"),
                @NamedQuery(name = "Folderfolders.findRoot", 
                            query = "select o from Folderfolders o where o.ffoldername = 'ICA' or o.fparentguid = 'FLD_ENTERPRISE_LIBRARY'"),
...
public class Folderfolders implements Serializable {
    private static final long serialVersionUID = -5268269228094540264L;
    ...
    public Folderfolders(BigDecimal fallocatedfoldersize, String fallocatorparentfolderguid, String fapplication,
                         ...
                         BigDecimal finhibitpropagation, BigDecimal fisaclreadonlyonui, BigDecimal fiscontribution,
                         BigDecimal fisintrash, BigDecimal fislibrary, BigDecimal fisreadonly,
                         Timestamp flastmodifieddate, String flastmodifier, BigDecimal flibrarytype, String fowner,
                         String fparentguid, BigDecimal fpromptformetadata, String frealitemguid, String fsecuritygroup,
                         String ftargetguid) {
